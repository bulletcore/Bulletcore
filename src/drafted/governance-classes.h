 ...
 *
 *   // network
 *   CBulletNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bulletcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBulletNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BulletNetwork
// //   -- signature requirements : Key1(User)
// class CBulletNetworkVariable : public CGovernanceObject
// {
// private:
