    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bullet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bullet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bullet: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bullet Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bullet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bullet Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bullet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bullet addresses"));
    ...
    openAction->setStatusTip(tr("Open a bullet: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bullet Core help message to get a list with possible Bullet Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bullet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bullet network", "", count));
}
...
{
    QString strTitle = tr("Bullet Core"); // default title
