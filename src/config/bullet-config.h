/* src/config/bullet-config.h.  Generated from bullet-config.h.in by configure.  */
/* src/config/bullet-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/bulletcoin/bullet/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bullet Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bullet Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bulletcore"
