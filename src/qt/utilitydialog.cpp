    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bullet Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bullet Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bullet-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bullet in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an bullettive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 BULLET, 0.1 BULLET, 1 BULLET and 10 BULLET -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bulletcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://bulletcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bullet Core is shutting down...") + "<br /><br />" +
