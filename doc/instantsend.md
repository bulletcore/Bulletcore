...
This mechanism has been integrated into Bitcore-Node-Bullet which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bulletcoin/insight-api-bullet#web-socket-api](https://github.com/bulletcoin/insight-api-bullet#web-socket-api) 
* API: [https://github.com/bulletcoin/insight-api-bullet#instantsend-transactions](https://github.com/bulletcoin/insight-api-bullet#instantsend-transactions) 
...
By default, the Bullet Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bullet Core daemon:
