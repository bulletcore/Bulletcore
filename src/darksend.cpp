...
{
    if(fLiteMode) return; // ignore all Bullet related functionality
...
/*
    ...
    allow endless transaction that would bloat Bullet and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("bullet-privatesend");
