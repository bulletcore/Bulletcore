    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BULLET-light"), QVariant("light"));
    ui->theme->addItem(QString("BULLET-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BULLET-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BULLET-traditional"), QVariant("trad"));
