...
2. run bulletd with -printalert or -sendalert like this:
   /path/to/bulletd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bulletcoin.info";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Bullet Core:0.12.0.58/"));
